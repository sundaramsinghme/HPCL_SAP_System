...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    public InvoiceResponseDTO createInvoice(InvoiceRequestDTO dto) {
        ...
        Cylinder cylinder = cylinderRepo.findBySerialNo(dto.serialNo())
                .orElseThrow(() -> new RuntimeException("Cylinder not found With Enter Serial No."));

        if (cylinder.getStatus() != CylinderStatus.ACTIVE) {
            throw new RuntimeException("Cylinder is not ACTIVE. Current status: " + cylinder.getStatus());
        }
    ...
    // return latest invoice of cylinder by invoice no
    @Override
    public InvoiceResponseDTO getInvoiceByInvoiceNO(String invoiceNo) {
