...
public class CylinderController {
    ...
    // Get Cylinder by ID
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<CylinderResponseDTO>> getCylinderById(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiResponse<CylinderResponseDTO>> getCylinderBySerialNo(@PathVariable Long serialNo) {
    ...
    // Delete Cylinder
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<String>> deleteCylinder(@PathVariable Long id) {
